...
class EventType(StrEnum):
    ...
    AGENT_PROCESS_START_FAILED = "AGENT_PROCESS_START_FAILED"
    MISSION_STATE_RECONCILED = "MISSION_STATE_RECONCILED"
    HANDOFF_RECORDED = "HANDOFF_RECORDED"
    LOCAL_GIT_STATE_OBSERVED = "LOCAL_GIT_STATE_OBSERVED"
    LOCAL_GIT_HARVEST_COMPLETED = "LOCAL_GIT_HARVEST_COMPLETED"
