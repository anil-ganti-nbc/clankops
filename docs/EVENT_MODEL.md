...
| `LOCAL_GIT_STATE_OBSERVED` | observation_id, clank_id, checkout_key, checkout_path, branch, detached, head, dirty, dirty_count, tracked_changes, untracked, upstream, upstream_ahead_local, upstream_behind_local, remotes `[{name,identity,redacted}]`, worktrees, state_fingerprint, observed_at |
